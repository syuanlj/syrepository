...
public class BindMobileDialog extends Dialog{
    ...
    private SafeCenterActivity.IBindMobileCallBack iBindMobileCallBack;
    EditText mobile;
    EditText code;
    Button sendCode;
    Button bindMobile;
    ...
    public BindMobileDialog(@NonNull Activity activity, SafeCenterActivity.IBindMobileCallBack iBindMobileCallBack, boolean isCanClose) {
