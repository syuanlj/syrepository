...
public class MineCardActivity extends BaseViewActivity<ShopContract.IMineShopCenterPresenter>
    ...
    @Override
    protected void init() {
        title.setText(R.string.add_card_string);
        ...
        initWebview();
        wv.loadUrl("http://api.app.51craftsman.com/h5_shop/card?user_id=" +
