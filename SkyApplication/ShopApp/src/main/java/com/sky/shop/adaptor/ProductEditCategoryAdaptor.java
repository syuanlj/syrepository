 ...
 * 商品分类列表适配器
 */
public class ProductEditCategoryAdaptor extends BaseRecyclerAdapter<ProductCategory> {
    ...
    public ProductEditCategoryAdaptor(Context context, List<ProductCategory> list, int flag){
        super(context, list);
