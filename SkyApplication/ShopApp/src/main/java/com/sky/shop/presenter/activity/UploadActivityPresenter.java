...
import com.sky.shop.model.SellMessageCompleteModel;
...
public class UploadActivityPresenter extends BasePresenter<ShopContract.IUploadView>
        implements ShopContract.IUploadPresenter{

    ShopContract.IUploadModel  iUploadModel;

    public UploadActivityPresenter(Context context, ShopContract.IUploadView view) {
        super(context, view);
