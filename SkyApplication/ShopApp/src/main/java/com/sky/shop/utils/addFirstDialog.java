...
class AddFirstDialog extends Dialog{
    ...
    public AddFirstDialog(@NonNull Activity activity, String name,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_add_first_category_layout);
