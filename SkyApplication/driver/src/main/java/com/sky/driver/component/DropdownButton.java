...
public class DropdownButton extends RelativeLayout {
    ...
    private void init() {
        View view =  LayoutInflater.from(getContext()).inflate(R.layout.driver_dropdown_tab_button, this, true);
        textView = (TextView) view.findViewById(R.id.driver_tab_txt_tv);
        bottomLine = view.findViewById(R.id.driver_tab_line);
    }
    ...
    public void setChecked(Drawable icon, boolean checked, boolean isShowLine) {
        if (checked) {
            textView.setTextColor(getResources().getColor(R.color.driver_colorPrimary));
            if (isShowLine){
