...
import com.sky.driver.bean.UpdateOut;
import com.sky.driver.contract.UpdateContract;
import com.sky.driver.presenter.UpdatePresenter;
...
public class SplashActivity extends BaseViewActivity<UpdateContract.IUpdatePresenter>
    ...
    private String packageUrl = "/com.sky.driver/package/";
    ...
    protected void init() {
        ...
        updateIn.setApp_type("android_sj");//工匠
    ...
    public void showDownloadSuccess(final UpdateOut updateOut) {
        if (null != updateOut && AppUtils.getAppVersion(this) < updateOut.getVersion()){//需要升级家
