...
import com.sky.driver.contract.QQContract;
import com.sky.driver.contract.UserContract;
import com.sky.driver.presenter.CodeActivityPresenter;
import com.sky.driver.presenter.LoginActivityPresenter;
import com.sky.driver.presenter.QQActivityPresenter;
...
import com.sky.driver.utils.WeixinLogin;
...
public class LoginActivity extends BaseViewActivity<UserContract.ILoginPresenter>
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.qqLogin = new QQLogin(this, QQLogin.DRIVER_APP_ID);
    }
    ...
    @Override
    protected void init() {
        title.setText(R.string.driver_login_string);
    }
