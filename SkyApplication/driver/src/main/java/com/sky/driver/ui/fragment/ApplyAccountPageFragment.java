...
import com.sky.driver.bean.AccountBean;
...
import com.sky.driver.ui.activity.user.ChoosWithdrawalseActivity;
...
public class ApplyAccountPageFragment extends BaseViewFragment<AccountContract.IApplyAccountPresenter>
    ...
    protected void init() {
        ...
        filter.addAction("com.sky.driver.account");
    ...
    protected int getContentViewLayoutID() {
        return R.layout.driver_account_apply;
    }
    ...
    private BroadcastReceiver myReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if ("com.sky.driver.account".equals(intent.getAction())){
