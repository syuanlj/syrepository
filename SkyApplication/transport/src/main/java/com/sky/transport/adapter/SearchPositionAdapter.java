...
public class SearchPositionAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.transport_location_item, null, false);
        ...
        if (datas != null && datas.size() > 0) {
            ...
            if (selectItemIndex == position) {
                viewHolder.img_cur_point.setImageResource(R.mipmap.transport_position_is_select);
            } else {
