...
import com.sky.transport.presenter.UpdatePresenter;
...
public class SplashActivity extends BaseViewActivity<UpdateContract.IUpdatePresenter>
    ...
    private String packageUrl = "/com.sky.transport/package/";
    ...
    protected void init() {
        ...
        updateIn.setApp_type("android_hj");//工匠
