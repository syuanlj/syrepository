    ...
    private View.OnClickListener onClick = new View.OnClickListener(){
        ...
        public void onClick(View v) {
            ...
            if (i == R.id.driver_take_photo_btn) {
                TakePhotoUtils.getInstance(activity).takePoto(Md5Util.md5("app_" +
                        System.currentTimeMillis() + StringUtil.randStr(6)) + ".png");
                dismiss();

            } else if (i == R.id.driver_pick_photo_btn) {
                TakePhotoUtils.getInstance(activity).choosePhoto(Md5Util.md5("app_" +
                        System.currentTimeMillis() + StringUtil.randStr(6)) + ".png");
                dismiss();
