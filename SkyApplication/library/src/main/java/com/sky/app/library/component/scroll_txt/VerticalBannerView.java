package com.sky.app.library.component.scroll_txt;
...
public class VerticalBannerView extends LinearLayout implements BaseBannerAdapter.OnDataChangedListener {
    ...
    private void setupAdapter() {
        removeAllViews();
        Log.i("xmy123456 setupAdapter ",mAdapter.getCount()+"");
        if(mAdapter.getCount() == 1){
            mFirstView = mAdapter.getView(this);
            mAdapter.setItem(mFirstView,mAdapter.getItem(0));
            addView(mFirstView);
        }else{
            Log.i("xmy123456 setupAdapter ","22222222222222222222");
            mFirstView = mAdapter.getView(this);
            mSecondView = mAdapter.getView(this);
            mAdapter.setItem(mFirstView,mAdapter.getItem(0));
            Log.i("xmy123456 setup 1 ",mAdapter.getItem(0).toString());
            mAdapter.setItem(mSecondView,mAdapter.getItem(1));
            Log.i("xmy123456 setup 2 ",mAdapter.getItem(1).toString());
            addView(mFirstView);
            addView(mSecondView);
