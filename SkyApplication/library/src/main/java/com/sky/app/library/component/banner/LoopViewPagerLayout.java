package com.sky.app.library.component.banner;
...
import com.sky.app.library.component.banner.adapter.LoopPagerAdapterWrapper;
import com.sky.app.library.component.banner.animate.DepthPageTransformer;
import com.sky.app.library.component.banner.animate.ZoomOutPageTransformer;
...
import com.sky.app.library.component.banner.scroller.LoopScroller;
...
public class LoopViewPagerLayout extends RelativeLayout {
    ...
    private int size = AppUtils.dip2px(getContext(), 8);//The size of the set point;
