package com.sky.app.library.component.banner.adapter;
...
public class LoopPagerAdapterWrapper extends PagerAdapter {
    ...
    public LoopPagerAdapterWrapper(Context context, ArrayList<BannerInfo> bannerInfos,
                                   OnBannerItemClickListener onBannerItemClickListener,
                                   OnLoadImageViewListener onLoadImageViewListener) {
