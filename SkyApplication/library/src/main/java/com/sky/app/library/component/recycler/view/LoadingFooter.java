package com.sky.app.library.component.recycler.view;
...
import com.sky.app.library.component.recycler.interfaces.ILoadMoreFooter;
import com.sky.app.library.component.recycler.progressindicator.AVLoadingIndicatorView;
import com.sky.app.library.component.recycler.recyclerview.ProgressStyle;
...
public class LoadingFooter extends RelativeLayout implements ILoadMoreFooter {
    ...
    private int hintColor = R.color.main_colorAccent;
    ...
    public void init(Context context) {
        ...
        indicatorColor = ContextCompat.getColor(getContext(), R.color.main_colorAccent);
