 ...
 * 区
 */
public class AreaActivity extends BaseViewActivity<MineContract.IAreaPresenter>
    ...
    public void initViewsAndEvents() {
        ...
        selectAreaAdaptor.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View itemView, int pos) {
                provCityArea.setArea_name(areaDetails.get(pos).getName());
                provCityArea.setArea_id(areaDetails.get(pos).getId());
                MainApplication.provCityArea = provCityArea;
                BaseAppManager.getInstance().finishActivity(AreaActivity.class);
                BaseAppManager.getInstance().finishActivity(CityActivity.class);
                BaseAppManager.getInstance().finishActivity(ProvActivity.class);
            }
        });
    ...
    private void onRefresh(){
        ...
        areaIn.setLevel("2");
        areaIn.setName(provCityArea.getCity_name());
        areaIn.setId(provCityArea.getCity_id());
